    ...
    <div class="container">
        ...
        <div class="form">
            ...
            <p class="char"><?= strlen($input) > 0 ?  "Input: $input" : '' ?></p>
             <p class="res">
                <p style="color: #f3ededff;">Result:</p>
               <?=  strlen($input) > 0 ? "<pre>" . htmlspecialchars(json_encode($freq,JSON_PRETTY_PRINT)) . "</pre>" : '' ?>
            </p>
        </div>
        
        <div class="footer">
            <p class="footer-p">Word Frequency Counter in php</p>
        </div>
    </div>
</body>
